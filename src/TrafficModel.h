...
typedef stdext::hash_map<double, double>::const_iterator FlowCongestionMapItr;
...
typedef stdext::hash_map<double, FlowCongestionMapPtr>::const_iterator CapacityFlowsMapItr;
